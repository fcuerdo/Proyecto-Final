...
**Ciclo de vida del dato dentro de Google Cloud Platform:**
<p align="center">
...
<p align="center">
  <img src="Recursos/Ciclo vida del dato en nube.png" alt="ciclo de vida del dato" width="600">
</p>
...
**B) Desarrollo de machine learning y su implementacion en la nube de GCP:**
Se realizÓ en primer lugar el desarrrollo del modelo de machine learning a nivel local con python.



**Link del GCP funcionando**
[GCP Funcionando](https://www.youtube.com/watch?v=pxHq9pUnxNM)
